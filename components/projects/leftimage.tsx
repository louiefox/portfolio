...
export default function ProjectPictureLeft(props: PictureLeftProps) {
  ...
  return (
    <>
      ...
      <div className="flex flex-col-reverse lg:flex-row gap-10 mt-20 md:mt-32 mx-5 lg:space-x-32">
        ...
        <div className="max-w-lg text-center md:text-left">
          ...
          <div className="flex flex-row items-center justify-center md:justify-start gap-3 mt-4">
